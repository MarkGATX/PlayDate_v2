...
export default function DashboardAdultInfo({ user }: { user: AdultsType }) {
  ...
  return (
    ...
    >
      ...
      <button
        className="mt-4 w-full transform cursor-pointer rounded-lg border-2 border-appBlue bg-appGold px-2 py-2 text-sm duration-200 ease-in-out hover:bg-blueGradient hover:bg-appBlue hover:text-appGold active:bg-appGold active:text-appBlue active:shadow-activeButton disabled:pointer-events-none disabled:opacity-50"
