...
export default function NotFound() {
  return (
    <main className="flex flex-col items-center justify-start overflow-y-hidden">
      <h2 className="w-full bg-blueGradient bg-appBlue p-4 text-center text-lg font-bold text-appBG">
        Page not found
      </h2>
      <div className="p-4">
        <p className="mb-4">
          {`We couldn't find any information to create a new Playdate.`}{" "}
        </p>
        <p className="mb-4">
          Try searching again on the home page and select a new location.
        </p>
        <Link href="/">
